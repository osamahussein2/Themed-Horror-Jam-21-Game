...
void GameScene::InitializeDay4()
{
    ...
    DIALOGUE_TEXT4_CHARACTER_SIZE = 50.0f * (((resolution.x / 1920.0f) + (resolution.y / 1080.0f)) / 2);

    dialogueTexts[0].InitializeText("Fonts/Roboto-Regular.ttf", DIALOGUE_TEXT4_CHARACTER_SIZE, false, false,
        sf::Color::White, Vector2f(textPanelX, textPanelY));

    dialogueTexts[1].InitializeText("Fonts/Roboto-Regular.ttf", DIALOGUE_TEXT4_CHARACTER_SIZE, false, false,
        sf::Color::White, Vector2f(textPanelX, textPanelY));

    dialogueTexts[2].InitializeText("Fonts/Roboto-Regular.ttf", DIALOGUE_TEXT4_CHARACTER_SIZE, false, false,
        sf::Color::White, Vector2f(textPanelX, textPanelY));
}
