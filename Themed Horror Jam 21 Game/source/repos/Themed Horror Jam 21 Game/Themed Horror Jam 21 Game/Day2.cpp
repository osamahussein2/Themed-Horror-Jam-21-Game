...
void GameScene::InitializeDay2()
{
    ...
    DIALOGUE_TEXT2_CHARACTER_SIZE = 40.0f * (((resolution.x / 1920.0f) + (resolution.y / 1080.0f)) / 2);

    for (int i = 0; i < maxDialogueTexts; i++)
    {
        dialogueTexts[i].InitializeText("Fonts/Roboto-Regular.ttf", DIALOGUE_TEXT2_CHARACTER_SIZE, false, false,
